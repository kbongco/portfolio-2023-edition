    ...
    <>
      <section className="social-links-portfolio">
        ...
        <p className="contact-text">
          {theme === "videoGame"
            ? "I am currently looking for my next quest where I can leverage some of my skills in web development. Specifically in full stack. If you like what you see and want me to join your party and help your current quest, help in your latest venture, or even if you just want to chat. Here are some links you can use to contact me! "
            : "I am currently looking for my next role where I can use my skills in web development, specifically in full stack! If you like what you see and you would like to speak to me about any new roles, want some help in design or development, or if you just want to chat here are some links you can use to contact me!"}
        </p>
